...
class FragmentoInventarioDetalhes:Fragment() {
    ...
    override fun onViewCreated(view:View, savedInstanceState:Bundle?) {
        ...
        val tabsIcones = arrayOf(
            R.drawable.ic_round_local,
            R.drawable.ic_round_tag,
            R.drawable.ic_round_item
        )
        ...
        b.apply {
            ...
            fabNovo.setOnClickListener {
                when (paginasInventarioDetalhes.currentItem) {
                    ...
                    2 -> {
                        (requireActivity() as MainActivity).mostrarSnackbar(view, R.string.inventarioDetalhesTabItens)
                    } // Itens
                }
            }
        }

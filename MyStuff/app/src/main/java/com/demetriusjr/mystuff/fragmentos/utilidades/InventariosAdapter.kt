...
class InventariosAdapter:ListAdapter<Inventario, InventariosAdapter.ViewHolder>(InventariosComparator()) {
    ...
    class InventariosComparator:DiffUtil.ItemCallback<Inventario>() {
         ...
         */
        override fun areItemsTheSame(oldItem:Inventario, newItem:Inventario):Boolean = oldItem.idInventario == newItem.idInventario
         ...
         */
        override fun areContentsTheSame(oldItem:Inventario, newItem:Inventario):Boolean = oldItem.nome == newItem.nome
    ...
    override fun onBindViewHolder(holder:ViewHolder, position:Int) {
        ItemListaBinding.bind(holder.itemView).apply {
            txtvEtiquetaPrimaria.text = getItem(position).nome
        }
    }
